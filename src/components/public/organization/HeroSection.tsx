  ...
  return (
    <div className="relative w-full h-[500px]">
      <img
        ...
        alt="Organization"
      />
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center space-y-8 px-6 bg-black bg-opacity-40">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <button 
              className="font-semibold transition-all duration-300 flex items-center space-x-2 bg-blue-600 text-white px-10 py-4 rounded-lg text-base hover:bg-blue-700"
            >
