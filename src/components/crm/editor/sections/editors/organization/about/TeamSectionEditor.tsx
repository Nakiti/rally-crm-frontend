...
export function TeamSectionEditor({ sectionData, sectionIndex }: TeamSectionEditorProps) {
      ...
      <div className="bg-gradient-to-r from-violet-50 to-purple-50 px-4 py-3 border-b border-gray-100">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div>
              <h3 className="font-semibold text-gray-900">Team Section</h3>
              <p className="text-xs text-gray-500">Showcase your team members</p>
            </div>
          </div>
