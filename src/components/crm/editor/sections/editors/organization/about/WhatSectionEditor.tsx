...
interface WhatSectionEditorProps {
  sectionData: {
    type: 'what';
    enabled: boolean;
    required: boolean;
...
export function WhatSectionEditor({ sectionData, sectionIndex }: WhatSectionEditorProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-cyan-50 to-blue-50 px-4 py-3 border-b border-gray-100">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div>
              <h3 className="font-semibold text-gray-900">What Section</h3>
              <p className="text-xs text-gray-500">Describe what your organization does</p>
            </div>
          </div>
