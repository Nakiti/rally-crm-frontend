...
interface WhySectionEditorProps {
  sectionData: {
    type: 'why';
    enabled: boolean;
    required: boolean;
...
export function WhySectionEditor({ sectionData, sectionIndex }: WhySectionEditorProps) {
      ...
      <div className="bg-gradient-to-r from-rose-50 to-pink-50 px-4 py-3 border-b border-gray-100">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div>
              <h3 className="font-semibold text-gray-900">Why Section</h3>
              <p className="text-xs text-gray-500">Explain why your organization exists</p>
            </div>
          </div>
