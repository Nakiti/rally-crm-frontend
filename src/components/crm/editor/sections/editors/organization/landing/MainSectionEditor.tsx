...
export function MainSectionEditor({ sectionData, sectionIndex }: MainSectionEditorProps) {
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 px-4 py-3 border-b border-gray-100">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div>
              <h3 className="font-semibold text-gray-900">Main Section</h3>
              <p className="text-xs text-gray-500">Primary content section</p>
            </div>
          </div>
