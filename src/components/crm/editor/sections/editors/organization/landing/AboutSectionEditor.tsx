...
export function AboutSectionEditor({ sectionData, sectionIndex }: AboutSectionEditorProps) {
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div>
              ...
              <p className="text-xs text-gray-500">Information about your organization</p>
            </div>
          </div>
      ...
      {sectionData.enabled && !sectionData.collapsed && (
        <div className="p-4 space-y-4">
          <div className="grid gap-4">
            ...
            <ImageUploader 
              label="About Image"
              currentImageUrl={sectionData.props.aboutImage}
              onUpload={(newUrl) => updateSectionField(sectionIndex, 'props.aboutImage', newUrl)}
            />
          </div>
        </div>
      )}
