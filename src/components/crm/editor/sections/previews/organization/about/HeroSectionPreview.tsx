    ...
    <div className="relative w-full h-96 overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
        <div className="max-w-4xl mx-auto space-y-8">
          <h1 className="font-bold text-white text-6xl leading-tight text-shadow-lg">
            {headline}
          </h1>
          <p className="text-xl text-white text-opacity-90 max-w-2xl mx-auto leading-relaxed text-shadow-md">
            {description}
          </p>
        </div>
      </div>
